...
(setq abandonment (concat "\\<" (regexp-opt '("instab" "unreliab" "support" "connection" "significant" "strength" "unstable" "outbursts" "imminent" "left" "moody" "alcohol" "withdrew" "withdraw" "alone" "abandon" "favor" "feel" "leave" "upset" "losing" "they'll" "they're" "addicted" "afraid" "available" "clinging" "coming" "committed" "defenseless" "desperate" "die" "fighting" "last" "leaves" "leaving"  "nice" "partners" "period" "prefer" "pulling" "regular" "self-absorbed" "short" "soon" "stable" "unpredictable" "worried")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("count" "drive")  t) "\\>")
      ...
      entitlement  (concat "\\<" (regexp-opt '("superior" "privilege" "spoiled" "overindulgent" "indulgent" "better" "most" "bound" "reciproc" "famous" "wealthy" "power"  "shouldn't" "tolerate" "tell" "rules" "restrictions" "priorities" "placed" "offer" "normal" "kept" "irritated" "irritable" "hate" "friends" "follow" "conventions" "procrastinat" "pout" "backstab" "complain" "controlling" "contributions" "constrained" "answer" "ahead")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("other" "control")  t) "\\>")
