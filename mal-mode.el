...
(setq abandonment (concat "\\<" (regexp-opt '("instability" "unreliability" "support" "connection" "significant" "strength" "unstable" "outbursts" "imminent" "abandon" "favor" "feel" "will" "leave" "upset" "losing" "they'll" "they're" "addicted" "afraid" "available" "base" "clinging" "coming" "committed" "defenseless" "desperate" "die" "drive" "expect" "fighting" "last" "leaves" "leaving" "next" "nice" "partners" "period" "prefer" "pulling" "regular" "self-absorbed" "short" "soon" "stable" "unpredictable" "worried")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("count")  t) "\\>")
      ...
      emotional-inhibition  (concat "\\<" (regexp-opt '("disapproval" "inhibition" "communic" "emotion" "emotionally" "anger" "warm" "uptight" "unemotional" "spontaneous" "show" "seriously" "positive" "likely" "inside" "gets" "emotions" "embarrassing" "build" "affection" "actions") t) "[A-Za-z]*\\>"  "\\|" "\\<" (regexp-opt '()  t) "\\>")

      enmeshment  (concat "\\<" (regexp-opt '("parent" "involve" "closeness" "survive" "support" "smother" "fuse" "emptiness" "empty" "flounder" "direction" "exist" "parents" "partner" "separate" "each" "living" "intimate" "speak" "separating" "privacy" "overinvolved" "other's" "lives" "keeping" "identity" "distance" "disappointed" "details" "day" "betrayed" "age")  t) "[A-Za-z]*\\>")

      entitlement  (concat "\\<" (regexp-opt '("superior" "privilege" "bound" "reciproc" "want" "famous" "wealthy" "power" "control" "shouldn't" "tolerate" "tell" "rules" "restrictions" "priorities" "placed" "offer" "normal" "many" "kept" "irritated" "irritable" "hate" "friends" "follow" "conventions" "controlling" "contributions" "constrained" "answer" "ahead")  t) "[A-Za-z]*\\>")

      insufficient-self-control  (concat "\\<" (regexp-opt '("goal" "restrain" "impuls" "avoid" "conflict" "responsibility" "easily" "complete" "temper" "stop" "stick" "start" "smoking" "slightest" "routine" "resolutions" "regret" "reach" "problem" "persevere" "overeating" "once" "offense" "long-range" "later" "impulsively" "hold" "frustrated" "force" "enjoy" "drinking" "discipline" "cost" "concentrate" "bored" "behaviors" "anything" "allow" "self-control" "self-discipline")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '()  t) "\\>")
      ...
      vulnerability  (concat "\\<" (regexp-opt '("might" "world" "serious" "attack" "vagrant" "strike" "street" "sick" "precautions" "physician" "heart" "happening" "financial" "escape" "disaster" "diagnosed" "developing" "destitute" "dangerous" "criminal" "crazy" "concerned" "careful" "being" "becoming" "attacked" "anxiety" "anxious" "vulnerability" "natural" "medical" "AIDS" "catastrophe" "collaps" "crash" "victim")  t) "[A-Za-z]*\\>")

      social-isolation  (concat "\\<" (regexp-opt '("was" "tomorrow" "outside" "notice" "loner" "isolated" "different" "group" "community" "fit" "families" "disappeared" "belong" "alienated" "alien")  t) "[A-Za-z]*\\>")

      defectiveness-shame  (concat "\\<" (regexp-opt '("bad" "unwanted" "inferior" "invalid" "unlovable" "blame" "comparison" "compare" "shame" "flaw" "awkward" "defects" "respect" "real" "man" "woman" "she" "he" "desire" "basic" "worthwhile" "unworthy" "unacceptable" "stay" "secrets" "saw" "reveal" "lovable" "knew" "inner" "inherent" "greatest" "fooling" "flawed" "fears" "fault" "face" "exposed" "drawn" "defective" "critical" "anyone")  t) "[A-Za-z]*\\>"  "\\|" "\\<" (regexp-opt '()  t) "\\>")
