...
;; * Continue to improve and refine the word lists.

(setq abandonment (concat "\\<" (regexp-opt '("instab" "unreliab" "support" "connection" "significant" "strength" "unstable" "outbursts" "imminent" "left" "moody" "alcohol" "withdrew" "withdraw" "alone" "abandon" "favor" "feel" "leave" "upset" "losing" "they'll" "they're" "addicted" "afraid" "available" "clinging" "coming" "committed" "defenseless" "desperate" "die" "fighting" "last" "leaves" "leaving"  "nice" "partners" "period" "prefer" "pulling" "regular" "self-absorbed" "short" "soon" "stable" "unpredictable" "worried")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("count" "drive")  t) "\\>")

      emotional-deprivation  (concat "\\<" (regexp-opt '("support" "adequate" "treat" "spent" "paid" "gave" "listen" "time" "isolat" "disconnect" "independ" "retreat" "solitar" "understood" "physical" "attention" "companion" "understanding" "listening" "disclosure" "sharing" "mutual" "direction" "guidance" "empathy" "nurturance" "haven't" "advice" "warmth" "wanted" "tuned" "true" "spend" "special" "sound" "share" "nurture" "holding" "himself" "herself" "gotten" "felt" "deeply")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '()  t) "\\>")

      emotional-inhibition  (concat "\\<" (regexp-opt '("disapproval" "everything" "express" "structur" "organiz" "familiar" "private" "communic" "emotion" "emotionally" "anger" "warm" "uptight" "unemotional" "spontaneous" "show" "seriously" "positive" "likely" "inside" "gets" "emotions" "embarrassing" "affection" "actions") t) "[A-Za-z]*\\>"  "\\|" "\\<" (regexp-opt '()  t) "\\>")

      enmeshment  (concat "\\<" (regexp-opt '("parent" "involve" "closeness" "survive" "support" "smother" "fuse" "emptiness" "empty" "flounder" "exist" "parents" "partner" "separate" "living" "intimate" "speak" "separating" "privacy" "overinvolved" "other's" "lives" "keeping" "individuality" "away" "identity" "distance" "disappointed" "details" "day" "betrayed" )  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("close" "own")  t) "\\>")

      entitlement  (concat "\\<" (regexp-opt '("superior" "privilege" "spoiled" "overindulgent" "indulgent" "better" "most" "bound" "reciproc" "famous" "wealthy" "power"  "shouldn't" "tolerate" "tell" "rules" "restrictions" "priorities" "placed" "offer" "normal" "kept" "irritated" "irritable" "hate" "friends" "conventions" "procrastinat" "pout" "backstab" "complain" "controlling" "contributions" "constrained" "answer" "ahead")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("other" "follow" "control")  t) "\\>")

      insufficient-self-control  (concat "\\<" (regexp-opt '("goal" "structure" "undisciplin" "disciplin" "restrain" "impuls" "exaggerat" "avoid" "conflict" "responsibility" "easily" "complete" "stick" "start" "smoking" "slightest" "routine" "resolutions" "compuls" "stimulat" "novel" "addict" "regret" "reach" "problem" "persevere" "overeating" "once" "offense" "long-range" "later" "impulsively" "hold" "frustrated" "force" "enjoy" "drinking" "discipline" "cost" "concentrate" "bored" "behaviors" "anything" "allow" "self-control" "self-discipline")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("temper")  t) "\\>")

      mistrust-abuse  (concat "\\<" (regexp-opt '("hurt" "humiliate" "deceived" "satisfy" "satisfied" "cheat" "lie" "harm" "unjustified" "negligence" "motives" "before" "advantage" "throughout" "well-intentioned" "used" "truth" "trusting" "trust" "towards" "suspicious" "purposes" "prove" "protect" "presence" "mistreated" "lookout" "intentionally" "manipulat" "seduc" "dishonest" "conn" "honest" "guard" "betrays" "belief" "appear" "after" "mistrust" "abus" "tests")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '()  t))

      subjugation  (concat "\\<" (regexp-opt '("surrender" "coerce" "retaliation" "suppress" "valid" "important" "compliance" "affiliat" "submiss" "comply" "trapped" "passive" "reject" "wishes" "upper" "rights" "retaliate" "respected" "pleasing" "lengths" "instead" "controlled" "opinion" "freedom" "regard" "terms" "fear" "demanding" "decisions" "consequences" "confrontations" "choices" "choice" "asking" "account")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("iron")  t) "\\>")

      self-sacrifice  (concat "\\<" (regexp-opt '("voluntar" "cause" "causing" "guilt" "maintain" "sacrifice" "sake" "family" "unhappy" "strong" "care" "pain" "others" "resentment" "codepend" "happy" "guilty" "busy" "volunteer" "uncomfortable" "taking" "return" "receiving" "minimal" "loved" "giving" "everyone" "ends" "else's" "disappoint" "couldn't" "comfortable" "self")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '()  t) "\\>")

      social-undesirability  (concat "\\<" (regexp-opt '("dissoc" "numb" "fantas" "wouldn't" "ugly" "status" "socially" "sexually" "self-conscious" "longer" "excess" "level" "fat" "educat" "dull"  "career" "boring" "attractive" "undesirab")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("decent")  t) "\\>")

      unrelenting-standards  (concat "\\<" (regexp-opt '("slow" "tight" "predictab" "ritual" "orderliness" "orderly" "nothing" "good" "strict" "rigid" "right" "proper" "quick" "well" "import" "satisfying" "attention" "should" "moral" "ethical" "precept" "efficien" "best" "expect" "pressure" "suffering" "suffer" "impress" "high" "strive" "standards" "settle" "second" "relax" "push" "pleasure" "performance" "perfect" "mistakes" "mistake" "look" "hook" "health" "happiness" "excuses" "done" "deserve" "criticism" "constant" "competitive" "achieve" "accomplish" "accept" "unrelenting")  t) "[A-Za-z]*\\>"  "\\|" "\\<" (regexp-opt '("under" "all" "order" "off")  t) "\\>")

      vulnerability  (concat "\\<" (regexp-opt '("might" "serious" "attack" "vagrant" "strike" "street" "sick" "precautions" "physician" "heart" "happening" "financial" "escape" "disaster" "phobic" "overprotect" "protect" "diagnosed" "developing" "destitute" "dangerous" "criminal" "crazy" "concerned" "careful" "being" "becoming" "attacked" "anxiety" "anxious" "vulnerability" "natural" "medical" "AIDS" "catastrophe" "collaps" "crash" "victim")  t) "[A-Za-z]*\\>")
      ...
      defectiveness-shame  (concat "\\<" (regexp-opt '("bad" "unwanted" "critic" "unlov" "ashamed" "inferior" "invalid" "unlovable" "blame" "comparison" "compare" "shame" "flaw" "awkward" "defects" "respect" "real" "desire" "basic" "worthwhile" "unworthy" "unacceptable" "stay" "secrets" "saw" "reveal" "lovable" "knew" "inner" "inherent" "greatest" "fooling" "flawed" "fears" "fault" "face" "exposed" "drawn" "defective" "critical" "anyone")  t) "[A-Za-z]*\\>"  "\\|" "\\<" (regexp-opt '("man" "woman" "she" "he")  t) "\\>")

      failure  (concat "\\<" (regexp-opt '("fail" "inadequate" "stupid" "succeed" "life" "taught" "untalented" "ignorant" "lower" "less" "failure" "school" "capable" "compare" "embarrassed" "failures" "humiliated" "inadequacies" "incompetent" "intelligent" "sphere" "successful" "talented")  t) "[A-Za-z]*\\>"  "\\|" "\\<" (regexp-opt '()  t) "\\>")

      dependence-incompetence  (concat "\\<" (regexp-opt '("unable" "judgment" "young" "exercise" "tackle" "everyday" "responsibilities" "handle" "need" "wrong" "unless" "tackling" "solve" "screw" "rely" "relied" "practical" "overwhelming" "issues" "inept" "help" "letting" "handling" "guide" "functioning" "dependent" "cope" "confident" "child" "believe" "adult" "ability" "dependence" "incompetence") t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '()  t) "\\>")
