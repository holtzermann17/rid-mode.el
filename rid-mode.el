...
(setq  primary-need-orality  (concat "\\<" (regexp-opt '("absinth" "ale" "ales" "alimentary" "ambrosia" "ambrosial" "appetit" "apple" "artichok" "asparagu" "bacon" "banana" "bean" "beef" "beer" "belch" "bellies" "belly" "berri" "berry" "beverag" "biscuit" "bite" "bite" "bites" "biting" "bitten" "bonbon" "brandy" "bread" "breakfast" "breast" "brew" "broth" "burp" "butter" "buttermilk" "cafe" "cafes" "cake" "cakes" "cafetaria" "candy" "cannibal" "caviar" "champagn" "chees" "cherri" "cherry" "chestnut" "chew" "chok" "cider" "claret" "cob" "cobs" "cocoa" "cocoanut" "coconut" "coffe" "consum" "cook" "corn" "cough" "cranberry" "cream" "delicaci" "delicacy" "dessert" "devour" "diet" "digest" "dine" "dines" "dining" "dinner" "dish" "dishes" "drank" "drink" "drunk" "drunken" "eat" "eaten" "egg" "entrail" "famin" "famish" "fat" "fatten" "feast" "fed" "feed" "feeds" "fig" "figs" "flour" "food" "foodstuff" "fork" "fruit" "garlic" "gin" "ginger" "gins" "glutton" "gluttonou" "gnaw" "gobbl" "grain" "grap" "grog" "gruel" "gulp" "gum" "gums" "gut" "guts" "ham" "hams" "herb" "honey" "hunger" "hungry" "imbib" "inedibl" "intestin" "jaw" "juic" "lap" "laps" "lemon" "lick" "lime" "limes" "lip" "lips" "liqueur" "liquor" "lunch" "maiz" "meal" "meat" "melon" "menu" "milk" "mint" "morsel" "mouth" "mouthful" "mushroom" "mutton" "naus" "nectar" "nibbl" "nourish" "nourishment" "nurtur" "nut" "nuts" "oliv" "oral" "palat" "partak" "pastri" "pastry" "pea" "peanut" "pear" "peas" "pepper" "philtr" "pineappl" "poison" "pork" "porridg" "potato" "potbel" "pots" "pucker" "pumpkin" "quench" "raspberry" "raw" "rawly" "repast" "restaurant" "restaurent" "rice" "rices" "ripenes" "roast" "rum" "rums" "salad" "saliva" "salivat" "salt" "sauc" "sauerkraut" "sesam" "sherbert" "sherry" "soup" "spat" "spit" "spittl" "spoon" "starv" "starvat" "stomach" "strawberri" "strawberry" "suck" "suckl" "sugar" "supper" "swallow" "tea" "teas" "teat" "teeth" "thirst" "thirsty" "throat" "tit" "tits" "tomato" "tongu" "tooth" "uncook" "veal" "vegetabl" "venison" "vodka" "vomit" "wheat" "whiskey" "whisky" "yam" "yams" "yeast")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("pot" "fast" "fasts")  t) "\\>")
      ...
      sensation-hard  (concat "\\<" (regexp-opt '("alabaster" "bras" "brassy" "brazen" "brittl" "bronz" "copper" "crisp" "crispy" "glas" "glassy" "granit" "gravel" "hard" "iron" "marbl" "metal" "metallic" "nail" "pebb" "porcelain" "rigid" "rock" "solid" "splinter" "steel" "stiff" "ston" "stony" "zinc" )  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("iron")  t) "\\>")
      ...
      timelessness  (concat "\\<" (regexp-opt '("always" "ceaseles" "centuri" "continual" "continuou" "endles" "endur" "eon" "eternal" "everlast" "immortal" "incessant" "lifetim" "outliv" "permanenc" "permanent" "perpetual" "timelessnes" "unceas" "undy" "unend")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("aeon" "century" "eternity" "everlast" "forever")  t) "\\>")
      ...
      icarian-descent  (concat "\\<" (regexp-opt '("base" "bases" "buri" "burrow" "bury" "descend" "descent" "dig" "digg" "digs" "dip" "dipp" "dips" "downhill" "downstream" "droop" "drop" "drops" "dug" "fall" "fallen" "fell" "headlong" "lean" "plung" "reced" "reclin" "sank" "sink" "slid" "slip" "stoop" "sundown" "sunk" "sunken" "sunset" "swoop" "toppl" "tumbl")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("dive")  t) "\\>")

      icarian-depth  (concat "\\<" (regexp-opt '("below" "beneath" "bottom" "canyon" "cave" "caving" "cellar" "chasm" "crevas" "deep" "deeper" "depth" "ditch" "down" "downward" "gutter" "hole" "holes" "low" "pits" "pitt" "precipitou" "ravin" "root" "submarin" "trench" "tunnel" "under" "underground" "underneath" "underworld" "valley" )  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("pit")  t) "\\>")
      ...
      icarian-water  (concat "\\<" (regexp-opt '("bath" "beach" "brook" "bubbl" "bucket" "creek" "damm" "damp" "dams" "dew" "dews" "dewy" "dike" "downpour" "drench" "shoring" "surf" "surfing" "drip" "fen" "flood" "fluid" "foam" "fountain" "gurgl" "humid" "lake" "lakes" "liquid" "moat" "moist" "moistur" "moss" "mosses" "ocean" "overflow" "perspir" "perspirat" "pond" "pool" "pour" "rain" "rainfall" "river" "saturat" "sea" "seas" "shore" "shores" "shower" "soak" "splash" "sprinkl" "steam" "steamy" "stream" "swam" "swamp" "swampy" "swim" "swum" "tide" "tides" "tiding" "trickl" "wade" "wading" "wash" "water" "waterfall" "wet")  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("dam")  t) "\\>")
      ...
      positive-affect  (concat "\\<" (regexp-opt '("amus" "amusement" "blith" "carefre" "celebrat" "cheer" "cheerful" "cheery" "chuckl" "delight" "delightful" "elat" "enjoy" "enjoyabl" "enjoyment" "entertain" "entertainment" "enthusiasm" "enthusiastic" "excit" "exhilerat" "exult" "exultant" "funny" "gaiety" "gay" "glad" "gladnes" "glee" "gleeful" "gleely" "gratifi" "gratify" "grin" "happines" "happy" "hilariou" "humor" "humorou" "humour" "humourou" "jocund" "jok" "jolly" "jovial" "joy" "joyful" "joyou" "laugh" "laughter" "merriment" "merry" "mirth" "mirthful" "overjoy" "playful" "pleasantry" "pleasur" "pleasurabl" "rejoic" "relief" "reliev" "rollick" "satisf" "smil" "thril" "thrill" "vivaciou" "vivacity" )  t) "[A-Za-z]*\\>" "\\|" "\\<" (regexp-opt '("fun")  t) "\\>")
      ...
      affection  (concat "\\<" (regexp-opt '("adore" "affect" "affectionat" "amorou" "amourou" "appreciat" "attractiv" "befriend" "belov" "bosom" "bridal" "bride" "cherish" "congenial" "cordial" "courtship" "darl" "dear" "devot" "embrac" "enamor" "enamour" "endear" "familiar" "fonder" "farewell" "favor" "favour" "fianc" "flirt" "fond" "fondnes" "fraternity" "friend" "friendship" "goodby" "grateful" "intimacy" "intimat" "kindly" "kindnes" "liked" "liking" "lov" "marri" "marriag" "marry" "mate" "mated" "mates" "mating" "mercy" "pat" "pats" "patt" "piti" "pity" "romanc" "sweetheart" "sympat" "unselfish" "warmheart" "welcom" "wooed" "wooing" "woos" )  t) "[A-Za-z]*\\>")
